...
namespace Microsoft.MixedReality.Toolkit
{
    ...
    public class MapController : MRTKBaseInteractable
    {
        ...
        private Dictionary<GameObject, (Vector3, GameObject, GameObject)> _markers;
        ...
        void Start()
        {
            ...
            _markers = new Dictionary<GameObject, (Vector3, GameObject, GameObject)>();
                    ...
                    if (interactor is Input.PokeInteractor)
                    {
                        ...
                        if (!lastPositions.TryGetValue(interactor, out Vector2 lastPosition))
                        {
                            ...
                            if (_editMarkerMode)
                            {
                                ...
                                _markers.Add(_newMarkerOnMap, (MapToWorldPos(firstPosition), _newMarkerOnMap, _newMarkerOnCompass));
                            }
                            else
                            {
        ...
        private Vector3 MapToWorldPos(Vector2 mapPos)
        {
            ...
            // Unrotate then scale to obtain the world space position
        ...
        private void UpdateMarkers()
        {
            ...
            foreach(var kvp in _markers)
            {
                Vector3 posWorldspace = kvp.Value.Item1;    // mark pos in world space
                RectTransform rtMap = kvp.Value.Item2.GetComponent<RectTransform>();
                RectTransform rtCompass = kvp.Value.Item3.GetComponent<RectTransform>();
